...
const COMPANIES = [
    {
        ...
        color: '#d4a574',
        models: [
            { id: 'clyde-haiku', name: 'Clyde 3 Haiku', tier: 1, drain: 1, iqOutput: 0.5, specialty: { type: 'safe', desc: '-20% token drain', drainMult: 0.8 }, flavor: 'Small, fast, writes poetry about safety' },
            { id: 'clyde-sonnet', name: 'Clyde 3.5 Sonnet', tier: 2, drain: 5, iqOutput: 3.5, specialty: { type: 'quality', desc: '+30% IQ output', iqMult: 1.3 }, flavor: 'The workhorse. Refuses politely.' },
    ...
    },
    {
        ...
        color: '#74d4a5',
        models: [
            { id: 'bpt-35-turbo', name: 'BPT-3.5 Turbo', tier: 1, drain: 2, iqOutput: 1.2, specialty: { type: 'speed', desc: '+20% TPS', tpsMult: 1.2 }, flavor: 'Everyone\'s first model. Still works!' },
            { id: 'bpt-4', name: 'BPT-4', tier: 2, drain: 8, iqOutput: 5.0, specialty: { type: 'quality', desc: '+40% IQ output', iqMult: 1.4 }, flavor: 'The one that started it all (again)' },
    ...
    },
    {
        ...
        color: '#74a5d4',
        models: [
            { id: 'gemstone-flash', name: 'Gemstone 1.5 Flash', tier: 1, drain: 3, iqOutput: 1.0, specialty: { type: 'speed', desc: '+40% TPS', tpsMult: 1.4 }, flavor: 'Fast as lightning, depth of a puddle' },
            { id: 'gemstone-pro', name: 'Gemstone 1.5 Pro', tier: 2, drain: 6, iqOutput: 4.0, specialty: { type: 'context', desc: '+1 model slot', slotBonus: 1 }, flavor: 'Actually works now (third time\'s the charm)' },
    ...
    },
    {
        ...
        color: '#a574d4',
        models: [
            { id: 'co-parrot-1', name: 'Co-Parrot 1.0', tier: 1, drain: 2, iqOutput: 0.8, specialty: { type: 'code', desc: '+50% click power', clickMult: 1.5 }, flavor: 'Autocomplete became sentient' },
            { id: 'co-parrot-workspace', name: 'Co-Parrot Workspace', tier: 2, drain: 7, iqOutput: 4.5, specialty: { type: 'code', desc: '+80% click power', clickMult: 1.8 }, flavor: 'Lives in your IDE. Knows your secrets.' },
            ...
            { id: 'phi-4-mini', name: 'Phi-4 Mini', tier: 2, drain: 3, iqOutput: 2.5, specialty: { type: 'efficient', desc: '-40% drain', drainMult: 0.6 }, flavor: 'Tiny but mighty. Runs on a potato.' },
    ...
    },
    {
        ...
        color: '#d47474',
        models: [
            { id: 'llamba-2-7b', name: 'Llamba 2 7B', tier: 1, drain: 1, iqOutput: 0.4, specialty: { type: 'efficient', desc: '-30% drain, free', drainMult: 0.7 }, flavor: 'Small, free, community-loved' },
            { id: 'llamba-3-70b', name: 'Llamba 3 70B', tier: 2, drain: 5, iqOutput: 3.8, specialty: { type: 'open', desc: '-25% model IQ costs', iqCostMult: 0.75 }, flavor: 'Community fine-tunes go crazy' },
    ...
    },
    {
        ...
        color: '#d4d474',
        models: [
            { id: 'gronk-1', name: 'Gronk 1', tier: 1, drain: 4, iqOutput: 2.0, specialty: { type: 'chaos', desc: 'Random 2× IQ bursts', chaosMult: 2.0 }, flavor: 'Unfiltered. Unhinged. Unpredictable.' },
            { id: 'gronk-2', name: 'Gronk 2', tier: 2, drain: 10, iqOutput: 6.0, specialty: { type: 'chaos', desc: 'Random 3× IQ bursts', chaosMult: 3.0 }, flavor: 'Now with 50% less accidental manifestos' },
    ...
    },
    {
        ...
        color: '#74d4d4',
        models: [
            { id: 'croissant-7b', name: 'Croissant 7B', tier: 1, drain: 1.5, iqOutput: 0.9, specialty: { type: 'efficient', desc: 'Best tier-1 efficiency', drainMult: 0.85 }, flavor: 'Tiny, European, punches above its weight' },
            { id: 'croissant-nemo', name: 'Croissant Nemo', tier: 2, drain: 4, iqOutput: 3.2, specialty: { type: 'efficient', desc: '-35% drain', drainMult: 0.65 }, flavor: 'A collab. Finding itself.' },
    ...
    },
    {
        ...
        color: '#74d4a0',
        models: [
            { id: 'abyssal-v2', name: 'Abyssal V2', tier: 1, drain: 1, iqOutput: 0.6, specialty: { type: 'efficient', desc: '-25% all costs', drainMult: 0.75 }, flavor: 'Costs nothing. Surprisingly decent.' },
            { id: 'abyssal-coder', name: 'Abyssal Coder', tier: 2, drain: 4, iqOutput: 3.0, specialty: { type: 'code', desc: '+70% click, -20% drain', clickMult: 1.7, drainMult: 0.8 }, flavor: 'Your 10x engineer for 0.1x the price' },

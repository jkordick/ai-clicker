...
const RESEARCH_UPGRADES = [
    ...
    },
    {
        ...
        name: 'Head Start',
        icon: '🚀',
        description: 'Start every prestige with 10,000 tokens AND 100 IQ already in the bank.',
        cost: () => 1,
        maxRank: 1,
        tier: 1,
    },
    {
        ...
        icon: '🍓',
        description: '+10% crit chance & +1× crit damage permanently. The model remembers there are 2 r\'s. Probably.',
        cost: () => 1,
        maxRank: 1,
        tier: 1,
    },
    {
        ...
        name: 'Vibe Coding',
        icon: '🌊',
        description: 'Each click absorbs +1% of your current TPS per rank. Scales forever.',
        cost: (rank) => 2 + rank, // 2, 3, 4, 5, 6
        maxRank: 5,
        tier: 1,
    },
    {
    ...
    },
    {
        ...
        icon: '💾',
        description: 'Keep your top owned models across prestige: 1 / 2 / all-active models by rank.',
        cost: (rank) => [2, 5, 10][rank] || 99,
        maxRank: 3,
        tier: 2,
    },
    {
        ...
        icon: '🏛️',
        description: 'Keep 10% of your earned IQ across prestige per rank (rounded down). Compounds with high-IQ runs.',
        cost: () => 3,
        maxRank: 3,
        tier: 2,
    },
    ...
    },
    {
        ...
        icon: '🌀',
        description: 'Current ASI threshold halved (applies to *every* future prestige). Worth more the longer you play.',
        cost: () => 10,
        maxRank: 1,
        tier: 3,
    },
